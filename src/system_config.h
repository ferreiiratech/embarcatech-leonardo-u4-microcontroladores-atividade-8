...
#define PWM_DIVISER 12.0                       // Divisor do PWM
#define WRAP_PERIOD 4096                       // Período do PWM
...
extern volatile uint8_t square_x;               // posição do quadrdo no eixo x
extern volatile uint8_t square_y;               // posição do quadrado no eixo y
